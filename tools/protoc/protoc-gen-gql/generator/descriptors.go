...
func IsEmpty(o *desc.MessageDescriptor) bool { return isEmpty(o, generator.NewCallstack()) }

// make sure objects are fulled with all objects
func isEmpty(o *desc.MessageDescriptor, callstack generator.Callstack) bool {
	callstack.Push(o)
