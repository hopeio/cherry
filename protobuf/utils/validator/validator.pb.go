...
// 	protoc        v5.26.1
// source: cherry/protobuf/utils/validator/validator.proto
...
func (x *FieldValidator) Reset() {
	*x = FieldValidator{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cherry_protobuf_utils_validator_validator_proto_msgTypes[0]
...
func (*FieldValidator) Descriptor() ([]byte, []int) {
	return file_cherry_protobuf_utils_validator_validator_proto_rawDescGZIP(), []int{0}
}
...
func (x *OneofValidator) Reset() {
	*x = OneofValidator{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cherry_protobuf_utils_validator_validator_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OneofValidator) Descriptor() ([]byte, []int) {
	return file_cherry_protobuf_utils_validator_validator_proto_rawDescGZIP(), []int{1}
}
...
var file_cherry_protobuf_utils_validator_validator_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "cherry/protobuf/utils/validator/validator.proto",
	},
	{
...
var (
	...
	E_Field = &file_cherry_protobuf_utils_validator_validator_proto_extTypes[0]
)

// Extension fields to descriptorpb.OneofOptions.
var (
	// optional validator.OneofValidator oneof = 65021;
	E_Oneof = &file_cherry_protobuf_utils_validator_validator_proto_extTypes[1]
)

var File_cherry_protobuf_utils_validator_validator_proto protoreflect.FileDescriptor

var file_cherry_protobuf_utils_validator_validator_proto_rawDesc = []byte{
	0x0a, 0x2f, 0x63, 0x68, 0x65, 0x72, 0x72, 0x79, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2f, 0x75, 0x74, 0x69, 0x6c, 0x73, 0x2f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f,
	...
	0x6f, 0x66, 0x42, 0x5e, 0x0a, 0x29, 0x78, 0x79, 0x7a, 0x2e, 0x68, 0x6f, 0x70, 0x65, 0x72, 0x2e,
	0x63, 0x68, 0x65, 0x72, 0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x75, 0x74, 0x69, 0x6c, 0x73, 0x2e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x5a,
	0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x6f, 0x70, 0x65,
	0x69, 0x6f, 0x2f, 0x63, 0x68, 0x65, 0x72, 0x72, 0x79, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x2f, 0x75, 0x74, 0x69, 0x6c, 0x73, 0x2f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	0x6f, 0x72,
}

var (
	file_cherry_protobuf_utils_validator_validator_proto_rawDescOnce sync.Once
	file_cherry_protobuf_utils_validator_validator_proto_rawDescData = file_cherry_protobuf_utils_validator_validator_proto_rawDesc
)

func file_cherry_protobuf_utils_validator_validator_proto_rawDescGZIP() []byte {
	file_cherry_protobuf_utils_validator_validator_proto_rawDescOnce.Do(func() {
		file_cherry_protobuf_utils_validator_validator_proto_rawDescData = protoimpl.X.CompressGZIP(file_cherry_protobuf_utils_validator_validator_proto_rawDescData)
	})
	return file_cherry_protobuf_utils_validator_validator_proto_rawDescData
}

var file_cherry_protobuf_utils_validator_validator_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cherry_protobuf_utils_validator_validator_proto_goTypes = []interface{}{
...
var file_cherry_protobuf_utils_validator_validator_proto_depIdxs = []int32{
...
func init() { file_cherry_protobuf_utils_validator_validator_proto_init() }
func file_cherry_protobuf_utils_validator_validator_proto_init() {
	if File_cherry_protobuf_utils_validator_validator_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cherry_protobuf_utils_validator_validator_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cherry_protobuf_utils_validator_validator_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cherry_protobuf_utils_validator_validator_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_cherry_protobuf_utils_validator_validator_proto_goTypes,
		DependencyIndexes: file_cherry_protobuf_utils_validator_validator_proto_depIdxs,
		MessageInfos:      file_cherry_protobuf_utils_validator_validator_proto_msgTypes,
		ExtensionInfos:    file_cherry_protobuf_utils_validator_validator_proto_extTypes,
	}.Build()
	File_cherry_protobuf_utils_validator_validator_proto = out.File
	file_cherry_protobuf_utils_validator_validator_proto_rawDesc = nil
	file_cherry_protobuf_utils_validator_validator_proto_goTypes = nil
	file_cherry_protobuf_utils_validator_validator_proto_depIdxs = nil
}
