...
func (formMultipartBinding) Bind(ctx fiber.Ctx, obj interface{}) error {
	if err := binding.MappingByPtr(obj, (*fbinding.MultipartRequest)(ctx.Request()), binding.Tag); err != nil {
		return err
	}
...
func (formBinding) Bind(ctx fiber.Ctx, obj interface{}) error {
	if err := binding.MapForm(obj, (*fbinding.ArgsSource)(ctx.Request().PostArgs())); err != nil {
		return err
	}
	return binding.Validate(obj)
}
